...
contract StarNotary is ERC721 {
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(msg.sender == sender1 || msg.sender == sender2, "You dont own any of these stars");
        require(sender1 != sender2, "You cant exchange with your own");
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(msg.sender == owner, "You dont own this star");
        require(_to1 != owner, "You cant transfer a star to your own");
